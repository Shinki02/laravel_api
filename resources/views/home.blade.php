    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <a href="{{route('post.create')}}" class="btn btn-susccess w-100 mb-2">Thêm bài viết</a>
                <a href="{{route('post.index')}}" class="btn btn-susccess w-100 mb-2">Liệt kê bài viết</a>
                </div>
            </div>
        </div>
    </div>
